...
exports.newInstance = function($, spec, cb) {
    try {
        ...
        var host = (spec.env.host === 'localhost') && (
        ...
        var getCFServiceConfig = function(typePrefix, name) {
            let vcapServices;
            vcapServices = typeof process.env.VCAP_SERVICES === 'string' ?
        ...
        that.getServiceConfig = function(typePrefix, name) {
            ...
            var result = spec.env[typePrefix] || null;
            ...
            if (spec.env.paas === 'kubernetes') {
                ...
                var msg = 'Ignoring service configuration under Kubernetes';
