...
exports.newInstance = function($, spec, cb) {
    try {
         ...
         *
         * @name platform_main#__ca_getAppName__
         * @function
         */
         ...
         *
         * @name platform_main#__ca_getAppFullName__
         * @function
         */
         ...
         *
         * @name platform_main#__ca_getAppSuffix__
         * @function
         */
        ...
        if (spec.env.synchronousInit) {
            that.__ca_start__(notifyF, function(err, _data) {
                if (err) {
                    cb(err);
                } else {
                    cb(null, that);
