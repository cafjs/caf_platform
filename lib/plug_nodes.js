 ...
 * port or encoded in the final external address.
 *
 ...
 * the notion of a private node identifier, that uses an non-externally routable
 *  IP address/port.
 *
 ...
 *      "leaseTimeout" : 5,
 *      "stealthNode" : false,
 *      "allPublicNodeIds" : [  // or 'null' if stealth and using a wildcard
 *       {
 *          "hostname" : "foo.com",
 *           "portRange" : [3000, 3500]
 *       },
