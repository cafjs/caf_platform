...
exports.newInstance = function($, spec, cb) {
    try {
        ...
        var isKubernetes = ($._.$.paas.getPaaS() === 'kubernetes');
        ...
        var allPublicNodeIds = null;
        // Search all nodes with kubernetes
        if (spec.env.allPublicNodeIds && !isKubernetes) {
            allPublicNodeIds = expandNodeIds();
        }
        ...
        var getKubernetesPublicNodeId = function() {
             ...
             */
            var ip = $._.$.paas.getAppHost().replace(/\./g, '-');
        ...
        if (spec.env.stealthNode) {
            ...
            var allIds = (isKubernetes ? [getKubernetesPublicNodeId()] :
                          allPublicNodeIds);
