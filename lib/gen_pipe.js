...
var gen_plug =  caf_comp.gen_plug;
...
exports.constructor = function($, spec) {
    ...
    var that = gen_plug.constructor($, spec);
     ...
     *
     * @type {boolean}
     * @name gen_pipe#__ca_isPipe__
     */
    that.__ca_isPipe__ = true;

    /**
     * Sends a reply on WebSockets or an http post.
     *
    ...
    that.__ca_send__ = function(res, data) {
        try {
            ...
            $._.$.log && $._.$.log.debug('Ignoring: Cannot send response ' +
                                         data + ' error: ' +
    ...
    /**
     * Whether this pipe should be added to the 'vanilla' http pipeline.
     *
