...
exports.newInstance = function($, spec, cb) {
    try {
        var connections = {};// track connections for fast shutdown
                ...
                if (err) {
                    ...
                    server
                        ...
                        .on('connection', function(con) {
                            var key = con.remoteAddress + ':' + con.remotePort;
                            connections[key] = con;
                    ...
                    wss.on('connection', function(ws) {
                        ws.on('message', function(msg) {
                            try {
                                ...
                                var sysErr;
                                sysErr = json_rpc
                                    .newSysError(msg, json_rpc.ERROR_CODES
                                                 .invalidParams,
                                                 'Invalid params', err);
